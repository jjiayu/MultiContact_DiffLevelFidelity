...
#filename = "/home/jiayu/Desktop/MultiContact_DiffLevelFidelity/Talos_Polytope/NLP_Good_FixedTiming/flat_NLP_previous/5LookAhead_Trial0.p"
...
for roundIdx in range(0,25):
    ...
    tempcontact = Contacts[roundIdx]
    plt.plot(tempcontact,marker='o', linewidth = 10)
